...
func New(ctx *context.ServerContext) http.Handler {
	...
	router.HandlerFunc(http.MethodGet, "/v1/watchlist/movies/:id", middleware.RequireAuthenticatedUser(h.WatchlistHandler.GetMoviesWatchlistHandler))
	...
	router.HandlerFunc(http.MethodGet, "/v1/watchlist/tv/:id", middleware.RequireAuthenticatedUser(h.WatchlistHandler.GetTvShowsWatchlistHandler))
	...
	router.HandlerFunc(http.MethodGet, "/v1/watched/movies/:id", middleware.RequireAuthenticatedUser(h.WatchedHandler.GetMoviesWatchedHandler))
	...
	router.HandlerFunc(http.MethodGet, "/v1/watched/tv/:id", middleware.RequireAuthenticatedUser(h.WatchedHandler.GetTvShowsWatchedHandler))
	router.HandlerFunc(http.MethodPost, "/v1/watched/tv/:id", middleware.RequireAuthenticatedUser(h.WatchedHandler.AddTvShowToWatchedHandler))
	router.HandlerFunc(http.MethodDelete, "/v1/watched/tv/:id", middleware.RequireAuthenticatedUser(h.WatchedHandler.DeleteTvShowFromWatchedHandler))
